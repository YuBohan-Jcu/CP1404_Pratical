...
#TO DO !!!!!!!
print(f"{year} {name} for about ${cost:,.0f}!") #to show the result {first} {second} {third} will be year,name and cost
# Aligning columns:
...
#TO DO !!!
for i in range(0,200,50):   #Set the function between 0-200, every word between 50
    print(f"{i:>3}")